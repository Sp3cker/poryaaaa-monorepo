...
static void run_loaded_voicegroup_cycles(const char* project_root, const char* voicegroup_name, int loops)
{
    for (int i = 0; i < loops; i++)
    {
...
int main(int argc, char** argv)
{
    ...
    {
        printf(
            "Running loaded voicegroup lifecycle harness: root=%s voicegroup=%s loops=%d\n", argv[2], argv[3], loops);
