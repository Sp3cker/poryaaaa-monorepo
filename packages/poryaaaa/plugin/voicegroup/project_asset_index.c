                                      ...
                                      const char* fileName)
{
    ...
    strncpy(idx->overrides[voiceIndex].fileName, fileName, sizeof(idx->overrides[voiceIndex].fileName) - 1);
...
bool project_asset_index_apply_overrides(const ProjectAssetIndex* idx, const char* projectRoot, LoadedVoiceGroup* vg)
{
    bool allOk = true;
