...
const NATIVE_OTHER_SOURCES: &[&str] = &[
    ...
    "voicegroup/voicegroup_materializer.c",
    "voicegroup/voicegroup_overflow.c",
    "voicegroup/voicegroup_project.c",
    "voicegroup/voicegroup_project_result.c",
    "voicegroup/voicegroup_project_asset.c",
    "voicegroup/vg_log.c",
...
const NATIVE_HEADERS: &[&str] = &[
    ...
    "voicegroup/voicegroup_project.h",
    "voicegroup/voicegroup_project_internal.h",
    "voicegroup/voicegroup_overflow.h",
