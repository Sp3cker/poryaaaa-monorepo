...
#define HW_RESAMPLE_BUFFER_SIZE 32768
     ...
     * Source frames are native signed PCM16; timestamp is shared while each
     * channel retains its own sample history. */
    typedef struct
    {
        double source_rate;
    ...
    /* Change rates without discarding the buffered source frames or phase. */
    ...
    /* Feed native signed PCM16 and drain up to max_out current-mGBA frontend samples. */
