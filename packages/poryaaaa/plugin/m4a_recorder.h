...
extern "C"
{
    ...
    void m4a_recorder_push_beats(M4ARecorder* recorder, double beats, uint8_t status, uint8_t d1, uint8_t d2);
    ...
    bool m4a_recorder_save_smf(const M4ARecorder* recorder, const char* path, uint16_t ppq, double tempo_bpm);
