...
/* Tables ported verbatim from pokeemerald disassembly via plugin/m4a_tables.c.
 * Keep these synchronized; the v1 tables remain in plugin/m4a_tables.c during
 * the rewrite so v1 keeps building unchanged. */
static const uint8_t gScaleTable[] = {
...
static const uint32_t gFreqTable[] = {
